...
export class TipoTramiteFormComponent implements OnInit {
  ...
  buscar(id) {
    this.gService.getBy(this.constant.tramite, id)
      .subscribe(
        (data: TiposTramite) => this.item = data,
        error => {
  ...
  onCreate() {
    ...
    this.gService.save(this.constant.tramite, this.item)
      .subscribe(
        (data: TiposTramite) => {
          this.confirmationService.confirm({
            ...
            reject: () => {
              ...
              // summary: 'Proceso Cancelado', detail: 'Se canceló la eliminación del registro' });
  ...
  onUpdate() {
    this.gService.update(this.constant.tramite, this.item)
      .subscribe(
        (data: TiposTramite) => {
          this.messageService.add({ severity: 'info', summary: 'Verifique', detail: 'Registro exitoso' });
          // this.cerrar();
