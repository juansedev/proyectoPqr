...
export class UsuarioListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.eventos.usuariosBusqueda.subscribe(() => console.log('emitida la busqueda'));
  ...
  fnBuscar() {
    ...
    this.gService.getAll(this.constant.usuarios, this.lcFiltros)
      .subscribe(
  ...
  fnConfirm(SelectedRow) {
    this.confirmationService.confirm({
      ...
      icon: 'fa fa-trash',
      accept: () => {
        this.gService.delete(this.constant.usuario, SelectedRow.id)
          .subscribe(
            (data: Usuarios) => {
